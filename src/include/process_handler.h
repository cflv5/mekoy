...
#define PROCESS_HANDLER_ERROR_SERVER_NOT_CONNECTED_TO_MASTER -2
#define PROCESS_HANDLER_ERROR_SERVER_ALREADY_CONNECTED_TO_MASTER -3
#define PROCESS_HANDLER_ERROR_NON_MASTER_OPERATION -4
#define PROCESS_HANDLER_ERROR_NO_PORT_DEFINED -5
#define PROCESS_HANDLER_ERROR_MEM_ALLOCATION -6
#define PROCESS_HANDLER_ERROR_NO_ADDR_DEFINED -7
